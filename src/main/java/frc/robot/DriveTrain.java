...
public class DriveTrain {
	...
	public DriveTrain(int LEFT_ID, int LEFT_MID_S_ID, int LEFT_FRONT_S_ID, int RIGHT_ID, int RIGHT_MID_S_ID,
			int RIGHT_FRONT_S_ID) {
		...
		leftDriveSlaveMid.setInverted(false);
		leftDriveSlaveFront.setInverted(false);

		rightDrive.setInverted(true);
		rightDriveSlaveMid.setInverted(true);
		rightDriveSlaveFront.setInverted(true);
	...
	public void leftWheelDrive(double speed) {
		...
		leftDriveSlaveMid.set(ControlMode.PercentOutput, speed * Constants.MAX_AUTO_DRIVE_SPEED);
	...
	public void rightWheelDrive(double speed) {
		...
		rightDriveSlaveMid.set(ControlMode.PercentOutput, speed * Constants.MAX_AUTO_DRIVE_SPEED);
	...
	public void stopDrive() {
		...
		leftDriveSlaveMid.set(ControlMode.PercentOutput, 0);
		leftDriveSlaveFront.set(ControlMode.PercentOutput, 0);
		rightDrive.set(ControlMode.PercentOutput, 0);
		rightDriveSlaveMid.set(ControlMode.PercentOutput, 0);
