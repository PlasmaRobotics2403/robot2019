...
public class HAB {
    ...
    HAB(int left_front_raise_ID, int right_front_raise_ID, int left_rear_raise_ID, int right_rear_raise_ID,
            int HAB_drive_ID, int HAB_Elevator_Limit_ID, int HAB_Arm_Limit_ID, DriveTrain driveTrain) {
    ...
    public void GyroHABClimb() {
        if (climbMode == false) {
            ...
            double speed = driveTrain.getGyroPitch() / 4;
